...
NUM_SIMS = 500        # the number of times to run the simulation (starting over each time)
SIM_TIME = 10      # how long each simulation should run, in seconds of simulation-time
